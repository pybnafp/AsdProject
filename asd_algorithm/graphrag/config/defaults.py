...
from graphrag.config.embeddings import default_embeddings, all_embeddings
...
class ChunksDefaults:
    ...
    encoding_model: str = "cl100k_base"  # 分词器
...
class EmbedTextDefaults:
    ...
    names: list[str] = field(default_factory=lambda: list(all_embeddings))
    strategy: None = None
...
class GlobalSearchDefaults:
    ...
    data_max_tokens: int = 24_000
    map_max_length: int = 3000
    reduce_max_length: int = 6000
