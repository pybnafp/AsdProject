...
from graphrag.config.models.extract_isolated_entity_relationships_config import (
    ExtractIsolatedEntityRelationshipsConfig,
)
...
class GraphRagConfig(BaseModel):
    ...
    extract_isolated_entity_relationships: ExtractIsolatedEntityRelationshipsConfig = Field(
        description="The isolated entity relationship extraction configuration to use.",
        default=ExtractIsolatedEntityRelationshipsConfig(),
    )
    """The isolated entity relationship extraction configuration to use."""
