<template>
  <div class="app-background">
    ...
    >
      <template #left>
        <img style="width: 28px;height: 28px" src="@/assets/img/icon-arrows-left.png" alt="" @click="goBack"/>
      </template>
    </van-nav-bar>
    <div class="chat-container">
      <div id="container" :style="{ height: mainWinHeight + 'px' }">
        <div class="chat-box" id="chat-box" :style="{ height: chatBoxHeight + 'px' }">
          <div class="chat-messages" v-for="item in messages" :key="item.message_id">
  ...
  if (chatId.value) {
    ...
    httpPost("/api/chat/detail", {chat_id: chatId.value})
        .then((res) => {
          ...
          title.value = res.data.chat.title
...
@import "@/assets/css/mobile/chat.styl"
.input-container {
  .el-textarea {
    .el-textarea__inner {
      padding-right 40px
